...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_DsX87Mps.mjs";
import { n as nowSec } from "./accounting_BipJ8jvJ.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_BKdyd1zK.mjs";
const SCOPE_GROUPS = {
  calendar: {
