...
import { googleStatus, SCOPE_GROUPS } from "./google_BKXUQu_e.mjs";
import { listCapabilities, CAPABILITY_LABEL } from "./capabilities_Ba681ROT.mjs";
import { getRetentionDays } from "./storage_4iye1Zw4.mjs";
const LIMITED_USE = [
