...
import { getSession, canDevelopApps } from "./auth_TPDi1U5M.mjs";
import { validateDefinition } from "./appdef_DMKxCl1j.mjs";
import { g as getAppDesign } from "./external-apps_H2ZAmhVv.mjs";
import { p as preflight } from "./preflight_B1R0Zxz-.mjs";
import { r as runDraftApp, p as platformInvariantSuspected, f as escalatePlatformInvariant } from "./app-runtime_m17xZ0ZN.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  try {
    await (await import("./external-apps_H2ZAmhVv.mjs").then((n) => n.A)).recheckDraft(ctx, draftId);
  } catch {
  }
