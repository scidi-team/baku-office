...
import { saveApiKey, getApiKey, deleteApiKey } from "./client_v-7HzW5v.mjs";
import { n as nowSec } from "./accounting_D4tRmfws.mjs";
import { clearServiceAccount, serviceAccountConfigured, serviceAccountAccessToken } from "./google-sa_D7hLOn87.mjs";
const SCOPE_GROUPS = {
  calendar: {
