...
import { APP_SCHEMA, validateDefinition } from "./appdef_DMKxCl1j.mjs";
import { ALLOWED_PERMISSIONS, PRIVILEGED_PERMISSIONS } from "./apps_CnHsjCoE.mjs";
...
async function scanLeakedSecrets(ctx, text) {
  const { listApiKeyNames, getApiKey } = await import("./client_v-7HzW5v.mjs");
